# from ..atg_web.settings.base import RABBIQ_MQ_URL
import pika
import sys
import json
...
# credentials = pika.PlainCredentials('smarteye_prod_heartbeat_user', 'vt6Su59PBe8^')
...
#http://smarteye_prod_heartbeat_user:vt6Su59PBe8^@cupid.smartflowtech.com:15672
connection = pika.BlockingConnection(pika.URLParameters(
    'http://smarteye_prod_heartbeat_user:vt6Su59PBe8^@cupid.smartflowtech.com'))
